...
import com.csii.controller.pushMsg.model.PushTemplateReq;
...
public class PushTemplateDemo {
    ...
    public static void main(String args[]){
        ...
        pushTemplateReq.setTemplatekv(templateKV);

        Map<String,String> extendedParam = new HashMap<String, String>();
        extendedParam.put("test","自定义扩展参数");
        pushTemplateReq.setExtended_params(extendedParam);

        Map<String,String> target = new HashMap<String, String>();
        String msgKey = String.valueOf(System.currentTimeMillis());
        target.put("1fe792f00163100080a730300a19467a",msgKey);
        pushTemplateReq.setTarget_msgkey(target);
